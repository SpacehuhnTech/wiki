...
{{% button href="https://github.com/SpacehuhnTech/wiki/issues/new?title=Changes for /wifiduck/content/usage/cli.md&body=I'd like to suggest changes for `/wifiduck/content/usage/cli.md`%0A%0A:link: [Wiki](https://spacehuhn.wiki//wifiduck/content/usage/cli)%0A:link: [Source](https://github.com/SpacehuhnTech/wiki/blob/master/content/en//wifiduck/content/usage/cli.md)%0A%0A<!-- Describe your desired changes -->" icon="fas fa-comment" %}}&nbsp;Suggest changes{{% /button %}}

{{% button href="https://github.com/SpacehuhnTech/wiki/blob/master/content/en//wifiduck/content/usage/cli.md" icon="fab fa-github" %}}&nbsp;Source{{% /button %}}